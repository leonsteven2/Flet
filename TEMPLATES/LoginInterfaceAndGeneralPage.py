import flet
from flet import Page, NavigationRail, FloatingActionButton, NavigationRailDestination, Icon, margin, padding, \
    IconButton, TextStyle, FontWeight, TextAlign, colors, TextCapitalization, Theme, UserControl, Container, icons, \
    ElevatedButton, SafeArea, Checkbox, Text, Column, TextField, Row, ImageFit, TextButton
...
class LoginInterface(UserControl):
    ...
    def send_a_email_to_recovery_password(self):
        pass
...
class MainInterface(UserControl):
    def __init__(self, page):
        ...
        # Agregamos un audio a la interfaz accionado por el IconButton de Musica
                ...
                controls=[
                    Container(
                        ...
                        gradient=flet.LinearGradient(
                            ...
                            colors=[colors.BLUE_GREY_800, colors.BLACK]
                        ),
                        expand=1,
                        content=Row(
                            controls=[
...
class CustomersPage(UserControl):
    ...
    def button_clicked(self, event):
        print("Presionado")
        self.row_main.controls.append(Text("Aqui estoy"))
        self.page.update(self)
